  ...
  function c(c, d) {
    (this.element = a(c)),
      ...
      (this.iconPicker = a("<div/>", {
        ...
        html:
          '<div class="selector"><span class="selected-icon"><i class="icon-line-cross"></i></span><span class="selector-button"><i class="icon-chevron-down"></i></span></div><div class="selector-popup" style="display: none;">' +
          (this.settings.hasSearch
            ? '<div class="selector-search"><input type="text" name="" value="" placeholder="Search icon" class="icons-search-input"/><i class="icon-search3"></i></div>'
            : "") +
  ...
  (c.prototype = {
    init: function() {
      ...
      if (
        ...
        this.triggerEvent =
          9 !== d && "oninput" in e ? ["input", "keyup"] : ["keyup"];
      }
                      ...
                      .each(
                        a.proxy(function(b, c) {
                          var e = a(c).val(),
                            f = a(c).html();
                          e &&
                            e !== this.settings.emptyIconValue &&
            ...
            : this.element.find("option").each(
                a.proxy(function(b, c) {
                  var d = a(c).val(),
                    e = a(c).html();
                  d &&
                    (this.settings.source.push(d), this.searchValues.push(e));
                }, this)
              ),
        ...
        this.iconPicker.find(".icons-search-input").keyup(
          a.proxy(function(b) {
            ...
            return "" === c
              ...
              : (this.searchIcon.removeClass("icon-search3"),
                ...
                a.grep(
                  ...
                  a.proxy(function(a, b) {
                    return a.toLowerCase().search(c.toLowerCase()) >= 0
                      ? ((this.iconsSearched[
                          this.iconsSearched.length
                        ] = this.settings.source[b]),
                        !0)
                      : void 0;
                  }, this)
                ),
            ...
            for (var f in b[c]) {
              var g = b[c][f],
                h =
                  ...
                  this.settings.searchSource[c][f]
                    ? this.settings.searchSource[c][f]
                    : g;
              "function" == typeof g.toString && (g = g.toString()),
                g &&
                  g !== this.settings.emptyIconValue &&
    ...
    renderIconContainer: function() {
      ...
      if (
        ...
        this.iconContainer.html(
          '<span class="fip-box alert-danger"><i class="icon-line-cross" data-fip-value="icon-line-cross"></i></span>'
        );
      else {
        if (c.length < 1)
          return (
            this.iconContainer.html(
              '<span class="icons-picker-error"><i class="icon-line-cross" data-fip-value="icon-line-cross"></i></span>'
            ),
            void 0
          );
        this.iconContainer.html("");
            ...
            ? this.iconPicker
                ...
                .html(
                  "<i " +
                    ...
                    '="' +
                    (this.settings.convertToHex
                      ? "&#x" + parseInt(a, 10).toString(16) + ";"
                      : a) +
                    '"></i>'
                )
            : this.iconPicker
                .find(".selected-icon")
                .html('<i class="icon-line-cross"></i>')
          : this.iconPicker
              .find(".selected-icon")
              .html('<i class="' + (a || "icon-line-cross") + '"></i>'),
        this.element
          .val("" === a ? this.settings.emptyIconValue : a)
          .trigger("change"),
    ...
    resetSearch: function() {
      this.iconPicker.find(".icons-search-input").val(""),
        ...
        this.searchIcon.addClass("icon-search3"),
