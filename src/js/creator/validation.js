...
const validation = () => {
  textInputs = document.querySelectorAll('input:not([type="file"]):not(.file-caption-name):not(.icons-search-input)');
  ...
  const imageInputsLength = document.querySelectorAll(".bad-validation-img").length;
