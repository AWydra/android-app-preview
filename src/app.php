    ...
    <main class="content">
        <section class="radio tab-content" id="radio">
            ...
            <div class="radio__buttons centered">
                ...
                <img src="https://fastcast4u.com/radio-directory/images/rolling.png" alt="Loading status bar"
                    class="rolling hidden" id="loading-spinner">
            </div>
        </section>
        ...
        <section class="fb tab-content" id="fb" style="display:none;">
            <iframe src="//fb.me/freeshoutcast/" frameborder="0" style="width:100%;height:100%;"></iframe>
        </section>

        <section class="twitter tab-content" id="twitter" style="display:none;">
            <iframe src="//twitter.com/FastCast4u/" frameborder="0" style="width:100%;height:100%;"></iframe>
        </section>

        <section class="instagram tab-content" id="instagram" style="display:none;">
            <iframe src="//instagram.com/" frameborder="0" style="width:100%;height:100%;"></iframe>
        </section>

        <section class="web tab-content" id="web" style="display:none;">
            <iframe src="//fastcast4u.com" frameborder="0" style="width:100%;height:100%;"></iframe>
        </section>

        <section class="addedweb tab-content" id="addedweb" style="display:none;">
            <iframe src="//fastcast4u.com/radio-directory" frameborder="0" style="width:100%;height:100%;"></iframe>
        </section>
